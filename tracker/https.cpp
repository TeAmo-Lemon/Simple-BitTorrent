...
void https::add_argument(const string& key, const buffer& value) {
...
void https::add_argument(const string& key, const string& value) {
...
void https::append(const string& s, buffer& b) {
	copy(s.begin(), s.end(), back_inserter(b));
}

void https::append(const buffer& s, buffer& b) {
	copy(s.begin(), s.end(), back_inserter(b));
}

string https::urlencode(const buffer &b) {
